...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-4A43T4KE.js";
import {
  useSize
} from "./chunk-Z5W2ZXMI.js";
import {
  Primitive,
...
var RemoveScroll = React8.forwardRef(function(props, parentRef) {
  ...
  return React8.createElement(
    React8.Fragment,
    null,
    enabled && React8.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React11.useState(false);
  ...
  return (0, import_jsx_runtime6.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime6.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React11.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React11.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React11.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React11.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    const contentRef = React11.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React11.useRef(false);
    React11.useEffect(() => {
...
var PopoverContentNonModal = React11.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React11.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
